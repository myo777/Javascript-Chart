  ...
  function createForces() {
    ...
    function createContinentForces() {
      ...
      function continentForceX(d) {
        if (d.ContinentCode === "Director") {
          return left(width);
        } else if (d.ContinentCode === "Senoior Manager") {
          return left(width);
        } else if (d.ContinentCode === "Senior Consultant") {
          return right(width);
        } else if (d.ContinentCode === "Consultant" || d.ContinentCode === "Manager") {
          return right(width);
        }
        return center(width);
      }
